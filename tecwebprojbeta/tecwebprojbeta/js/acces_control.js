...
function controlli(){
	...
	var controll = [["form_useremail", "User e-mail"],
...
if ((useremail == "") || (useremail == "undefined") || (useremail == "User e-mail")) {
    ...
    return false; 
  	...
  	form.action = "../cgi-bin/acc_control.cgi";// qui ci va l'indirizzo del file cgi che gestirà l'accesso
	form.submit();
}
}